...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <!--Person Header--!>
      <h3 class="page-header">Person: Fluuer de Fluer le Ammadu Owns</h3>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="stats-sub">
            ...
            <div class="row">
              <div class="col-md-12">
                <p class="stat-item-sub">Name <span class="stat-count-sub">Ahmed Riyazi Mohammed</span></p>
                <p class="stat-item-sub">Something <span class="stat-count-sub">4</span></p>
                <p class="stat-item-sub">Sexual Orientation <span class="stat-count-sub">unstable</span></p>
              </div>
              <div class="col-md-6">
        ...
        <div class="col-md-6">
          <div class="panel panel-default">
            <div class="panel-body">
              ...
              <a class="btn btn-success" href="#" role="button">Report n update</a>
            </div>
          </div>
        </div>
